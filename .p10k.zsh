# Generated by Powerlevel10k configuration wizard on 2021-12-26 at 16:28 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=1
  ...
  typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=1
  ...
  typeset -g POWERLEVEL9K_INSTANT_PROMPT_COMMAND_LINES=0 # THIS IS ADDED BY ME TO STICK THE PROMPT TO THE BOTTOM OF THE TERMINAL WINDOW
